'''A thief sneaks into a museum and wants to steal N exhibits. Each 
exhibit has its own weight and price. The thief can make M passes, each time 
each time taking away K kg of weight. Determine what the thief has to take so that the sum of 
of the stolen goods will be maximal.'''
import random
